...
# Debugging: Display filtered athlete bio data
print(filtered_athlete_bio_df.show())
...
results_df.writeStream.format("console").outputMode("complete").start()
...
# # Debugging: Display joined dataframe in console
# joined_df.writeStream.format("console").outputMode("append").start()
...
# # Debugging: Log grouped averages to console
# grouped_avg_df.writeStream.format("console").outputMode(
#     "update"
